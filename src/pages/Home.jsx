...
//         <h1>{t.hero.slogan}</h1>
//         <p>{t.hero.intro}</p>
//         <Link to="/about" className="cta">{t.hero.learnMore}</Link>
//       </section>
...
//             <h3>{S.consulting}</h3>
//             <p>{/* brief teaser text can be added via JSON later */}</p>
...
//           <div className="card partnerships">
...
//       {/* HERO */}
//       <section className="hero">
//         <h1>{t?.hero?.slogan ?? "Londoño Fajardo & Asociados"}</h1>
//         <p>{t?.hero?.intro ?? "Intro placeholder."}</p>
...
//         <div className="services-grid">
//           <div className="service-item">
//             <h3>{t?.services?.consulting ?? "Consultoría Legal"}</h3>
//             <Link className="btn-link" to="/consulting">→</Link>
//           </div>
//           <div className="service-item">
//             <h3>{t?.services?.property ?? "Propiedad Industrial"}</h3>
//             <Link className="btn-link" to="/property">→</Link>
//           </div>
//           <div className="service-item">
//             <h3>{t?.services?.structuring ?? "Estructuración de Patrimonios"}</h3>
//             <Link className="btn-link" to="/structuring">→</Link>
//           </div>
//         </div>
//       </section>
